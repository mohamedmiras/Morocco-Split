...
export default function Sidebar() {
 ...
 return (
  ...
  className={`fixed md:relative inset-y-0 left-0 flex flex-col h-screen bg-white border-r border-slate-100 shadow-[4px_0_24px_rgba(0,0,0,0.02)] transition-all duration-300 z-40 md:z-30 md:translate-x-0 ${
